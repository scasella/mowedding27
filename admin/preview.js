    ...
    render: function () {
      ...
      return page([
        h("section", { className: "section", key: "air" },
          h("div", { className: "shell" },
            h("div", { className: "section-head" }, h("p", { className: "kicker" }, "By air, rail & road")),
        ...
        h("section", { className: "section", key: "stay" },
          h("div", { className: "shell" },
            h("div", { className: "section-head" },
              ...
              h("h2", { className: "h-md mt-m" }, "A few good beds nearby."),
              h("p", { className: "lede muted mt-s", style: { maxWidth: "54ch" } }, "We’re holding a room block at the hotel below, with another lovely option close by. Do book early — a Friday wedding means many of us arriving at once.")),
        ...
        h("div", { className: "shell" },
          h("div", { className: "welcome" },
            ...
            h("aside", { className: "welcome__aside" },
              imgBox(null, "The essentials · facts & RSVP", true, { minHeight: "160px", borderRadius: "3px", background: "var(--harbor)" }))))),
